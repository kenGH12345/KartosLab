...
| [add-controlled-textfield.md](add-controlled-textfield.md) | 随 setState 频繁重建的场景使用受控 TextField（initState 建一次 / didUpdateWidget 仅外部 value 变化才同步 / dispose · 交互类 AC 验证清单） | 2026-08-28 |
