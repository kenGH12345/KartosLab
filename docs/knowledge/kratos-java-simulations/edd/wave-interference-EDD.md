...
> **蓝本**：`c:\workspace\kartosTrunk\kartosTrunk\simulations-java\simulations\wave-interference\` · 196 Java 文件
...
> **数据源**：`PHET_JAVA_ROOT/simulations-java/simulations/wave-interference/src/edu/colorado/kartos/waveinterference/**/*.java`
...
| 组件 | 路径 | 必用 |
|---|---|---|
| KratosSlider（频率/振幅/缝宽/缝间距/波长） | `lib/common/controls/` | 必用 |
| KratosRadioGroup（水/声/光子屏 · 单/双缝 · 脉冲开关） | `lib/common/controls/` | 必用 |
