...
class KratosSlider extends StatelessWidget {
  ...
  /// 紧凑模式：隐藏 label 行（仅滑块 · 用于顶部/底部窄条控件栏）。
  final bool compact;
...
class KratosSliderField extends StatefulWidget {
  const KratosSliderField({
    super.key,
    required this.label,
    required this.min,
    required this.max,
  ...
  @override
  State<KratosSliderField> createState() => _KratosSliderFieldState();
}

class _KratosSliderFieldState extends State<KratosSliderField> {
  ...
  @override
  void didUpdateWidget(covariant KratosSliderField oldWidget) {
