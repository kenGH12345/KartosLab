        ...
        KnowledgeSection.list(
          ...
          items: const [
            KnowledgeItem(
              ...
              desc: '平行于主光轴的光线经过透镜后会聚(或反向延长线会聚)于焦点F。透镜中心到焦点的距离叫焦距f。'
            ...
            KnowledgeItem(
              ...
              titleColor: Color(0xFF22C55E),
              desc: '实像：光线实际汇聚而成,可用光屏承接（如投影仪成像）。虚像：光线反向延长线汇聚,不能用光屏承接（如放大镜看到的像）。'
            ...
            KnowledgeItem(
              ...
              desc: '人眼(晶状体=凸透镜,视网膜=光屏)、照相机(镜头=凸透镜,底片=光屏)、投影仪(强光源+凸透镜)、'
